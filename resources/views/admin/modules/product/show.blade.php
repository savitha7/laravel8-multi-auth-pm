        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    {{ __('Product:') }}  {{$name}}                 
                    <x-app-icon-link :href="route('product.index')" class="float-right"><i class="fas fa-arrow-left fa-fw"></i></x-app-icon-link >
                </div>
            </div>

            <!--Card-->            
            <div id='recipients' class="p-8 lg:mt-0 rounded shadow bg-white">
            <div class="mt-4"> <span class="font-bold">{{ __('Status:') }}</span>  {!!$status?withLabel('Enabled','green'):withLabel('Disabled','red')!!}  </div>
